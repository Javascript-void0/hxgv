...
score = 0
score_text = cvs.create_text(1100, 50, text="Score: 0", font = ('Helvetica', 20), fill="white")
...
def move_ball():
    ...
    if y > 800 and game_over == False:
        game_over = True
        game_over = cvs.create_text(600, 400, text="Game Over", font = ('Helvetica', 50), fill="green")

def det_ball_brick_collission():
    global ball_speed_y, score
    x, y = get_pos(ball)
